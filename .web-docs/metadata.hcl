...
integration {
  ...
  identifier  = "packer/bdwyertech/aws"
  flags = [
  ...
  docs {
    ...
    external_url = "https://github.com/bdwyertech/packer-plugin-aws"
  }
  license {
    type = "MPL-2.0"
    url  = "https://github.com/bdwyertech/packer-plugin-aws/blob/main/LICENSE.md"
  }
  component {
    type = "builder"
    name = "AppStream Image Builder"
    slug = "appstream-image-builder"
  }
  component {
    type = "data-source"
    name = "AppStream Image"
    slug = "appstream-image"
  }
  component {
    type = "data-source"
    name = "AppStream Image Builder"
  ...
  component {
    type = "post-processor"
    name = "AppStream Share"
    slug = "appstream-share"
  }
  component {
    type = "post-processor"
    name = "AMI Copy"
