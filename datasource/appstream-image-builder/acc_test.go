...
func TestAccImageBuilderDatasource_Basic(t *testing.T) {
	testCase := &acctest.PluginTestCase{
		...
		Type:     "aws-appstream-image-builder", // This is technically the plugin name, but for acc tests it might not matter as much if we are just running packer
...
func TestAccImageBuilderDatasource_NonExtant(t *testing.T) {
	testCase := &acctest.PluginTestCase{
		Name: "image_builder_datasource_non_extant_test",
		Setup: func() error {
			return nil
		},
		Teardown: func() error {
