...
type FlatConfig struct {
	...
	WatermarkNames        []string                          `mapstructure:"watermark_names" cty:"watermark_names" hcl:"watermark_names"`
}
...
func (*FlatConfig) HCL2Spec() map[string]hcldec.Spec {
	s := map[string]hcldec.Spec{
		...
		"watermark_names":               &hcldec.AttrSpec{Name: "watermark_names", Type: cty.List(cty.String), Required: false},
	}
	return s
}
