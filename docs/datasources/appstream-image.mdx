Type: `appstream-image`

The `appstream-image` data source is used to fetch information about existing AWS AppStream 2.0 images. This is useful for querying available images, finding the latest version of an image, or getting details about a specific image to use in your Packer build.
